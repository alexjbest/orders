...
\] %TODO can we just require 2 finite
\end{cor}
...
While the polynomial does change if a different ring generator is used (i.e using some $\alpha + n$ instead of $\alpha$, with $n\in\ZZ$) the different polynomials will give isomorphic curves.%TODO monogenics etc.
...
gives the curve $E'\colon ...$ which is isomorphic to $E$!%TODO
\end{ex}
